...
method: 提出一种模块化的POMDP系统，通过融合语言、手势和视觉信息，同时对目标物体的身份和空间位置进行不确定性建模与规划。
result: "在仿真环境中实现了89%的平均成功率，显著优于单模态基准，并在真实四足机器人实验中验证了其感知的鲁棒性。"
conclusion: LEGS-POMDP成功结合了多模态融合与系统化规划，为机器人在部分可观测环境下的复杂物体搜索提供了有效的解决方案。
---
