...
method: 提出ResWM框架，通过残差动作建模和观测差异编码器，将控制逻辑从绝对值转向增量调整。
result: 在DeepMind Control Suite实验中，ResWM在采样效率、最终收益和动作平滑度上均显著超越了Dreamer和TD-MPC等基准。
conclusion: 残差动作建模是提升世界模型稳定性和机器人控制性能的一种简单且有效的原则。
---
