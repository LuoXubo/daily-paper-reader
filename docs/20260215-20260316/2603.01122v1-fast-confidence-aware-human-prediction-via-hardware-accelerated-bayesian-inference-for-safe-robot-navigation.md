...
title_zh: 通过硬件加速贝叶斯推理实现用于机器人安全导航的快速置信度感知人类预测
authors: "Michael Lu, Minh Bui, Xubo Lyu, Mo Chen"
date: 2026-03-01
pdf: "https://arxiv.org/pdf/2603.01122v1"
tags: ["query:rob-ai"]
score: 8.0
evidence: 自主系统中使用贝叶斯推理实现机器人安全导航
tldr: 本研究针对机器人在拥挤环境中的安全导航问题，提出了一种基于硬件加速贝叶斯推理的置信度感知预测框架。该方法将未来预测视为粒子，利用GPU高度并行化处理，实现了125Hz的高频长时预测，并支持多目标预测。相比现有方法，该方案提供了更细致的时间步长和轨迹预测，使规划器能敏锐捕捉人类行为变化。实验证明，该方法能有效提升机器人在动态环境中的共存能力与导航安全性。
selection_source: fresh_fetch
motivation: 机器人在复杂动态环境中需要实时、高精度的多人类行为预测，以确保安全且高效的路径规划。
method: 提出一种基于GPU加速的贝叶斯粒子滤波框架，通过并行化处理实现高频、多目标的置信度感知轨迹预测。
result: 实现了125Hz的预测频率和更精细的时间分辨率，显著提升了机器人对人类细微行为变化的响应速度。
conclusion: 该硬件加速的预测方法为动态环境下的机器人安全导航提供了强有力的实时计算支撑，增强了人机共存的鲁棒性。
---

## 摘要
随着机器人越来越多地融入日常生活环境，确保其在人类周围的安全导航变得至关重要。高效且安全的运动规划要求机器人考虑人类行为，特别是在杂货店或养老院等受限空间中，与多人的交互非常普遍。先前的研究采用了贝叶斯框架，根据导航意图对人类理性进行建模，从而能够预测用于规划目的的概率轨迹。在这项工作中，我们提出了一种简单而新颖的置信度感知预测方法，将未来的预测视为粒子。该框架在图形处理器（GPU）上实现了高度并行化和加速。因此，它能够以 125 Hz 的频率进行更长期的预测，并可轻松扩展到多人类预测。与现有方法相比，我们的实现支持更精细的预测时间步长，从而产生更细粒度的轨迹预测。这种增强的分辨率使运动规划器能够有效地响应人类行为的细微变化。我们通过真实世界的实验验证了我们的方法，展示了机器人在具有不同导航目标的多个行人之间安全导航。我们的结果突显了该方法在动态环境中实现鲁棒且高效的人机共存的潜力。
